<?php
define('DATABASE_NAME', strtoupper(get_current_user()) . '_bdl');
...
define("ASSOCIATION_NAME", "Black Dog Lane Road Association");

define("ASSOCIATION_NAME_SHORT", "BDL");

define("TAX_PERCENT", .02);

define("YEAR_COST", 10000);

define("TOTAL_PROPERITES", 10);
