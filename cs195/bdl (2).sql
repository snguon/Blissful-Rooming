...
(1, '101 Black Dog Lane', '', 'Hyde Park', 'VT', '05655', '2014-12-31 20:10:02'),
(2, '321 Black Dog Lane', '', 'Hyde Park', 'VT', '05655', '2014-12-31 20:11:38'),
(3, '142 Black Dog Lane', '', 'Hyde Park', 'VT', '05655', '2014-12-31 20:11:54'),
(4, '575 Black Dog Lane', '', 'Hyde Park', 'VT', '05655', '2014-12-31 20:12:18'),
(5, 'norm Black Dog Lane', '', 'Hyde Park', 'VT', '05655', '2014-12-31 20:13:21'),
(6, 'jim h Black Dog Lane', '', 'Hyde Park', 'VT', '05655', '2014-12-31 20:13:36'),
(7, '160 Sunset Drive', '', 'Morrisville', 'VT', '05661', '2014-12-31 20:13:49'),
(8, 'jim c Black Dog Lane', '', 'Hyde Park', 'VT', '05655', '2014-12-31 20:18:07'),
(9, '8808 Kensington Parkway', '', 'Chevy Chase', 'MD', '20815', '2014-12-31 22:09:43'),
(10, '97 Ferry Street', '', 'Barrington', 'RI', '02806', '2014-12-31 22:09:43'),
(11, '15 Woodlawn Drive', '', 'Esse Junction', 'VT', '05452', '2014-12-31 22:10:10');
...
CREATE TABLE IF NOT EXISTS `tblBill` (
  `pmkBillId` int(11) NOT NULL,
  `fldBillName` varchar(100) NOT NULL,
  `fldNotes` text NOT NULL,
  `fldBillAmount` float NOT NULL,
  `fldBillAmountPaid` float NOT NULL,
...
(1, 'Road Maintenance', 'As needed', 1, '2015-06-23 18:01:49'),
(2, 'Road Maintenance', 'Yearly', 0, '2015-06-23 18:01:49'),
(3, 'Pool', 'Yearly', 1, '2014-12-31 20:03:07'),
(4, 'Snow Removal', 'Per Event', 0, '2014-12-31 20:03:07'),
(5, 'Gardens', 'Yearly', 0, '2014-12-31 20:04:42'),
(6, 'Sidewalk Shoveling', 'Per Event', 1, '2014-12-31 20:04:42'),
(7, 'Tennis', 'Yearly', 1, '2014-12-31 20:06:03'),
(8, 'Dog Walking', 'Yearly', 0, '2014-12-31 20:06:03'),
(9, 'Dog Walking', 'Per Event', 0, '2014-12-31 20:06:47');
...
(1, '05-013-58', 2012, 273700, 2, 'C', 'poly', '115,290,88,263,105,263,111,244,112,219,121,218,140,230,151,229', 'Reg', '2015-06-24 21:12:48'),
(2, '05-13-114', 2012, 350800, 4, 'B', 'poly', '50,204,59,185,100,203,109,220,109,240', 'Toby', '2015-06-24 21:08:45'),
(3, '05-13-120', 2012, 279800, 7, 'A', 'poly', '108,242,49,205,40,216,86,261,100,261', 'Mitchel', '2015-06-24 21:12:22'),
(4, '05-013-104', 2012, 175400, 5, 'E', 'poly', '129,54,59,184,100,200,112,217,120,217,120,185,147,139,190,156,216,102', 'Privy', '2015-06-24 03:58:01'),
(5, '05-013-068.100', 2012, 329500, 9, 'F', 'poly', '148,139,202,170,189,193,166,208,161,207,152,195,146,181,128,178', 'Fred', '2015-06-24 03:58:15'),
(6, '05-013-068', 2012, 283000, 11, 'D', 'poly', '129,179,121,186,122,216,143,228,154,228,161,210,150,195,144,180', 'Jim', '2015-06-24 03:57:57'),
(7, '06-013-084', 2012, 102700, 11, 'G', 'poly', '213,117,371,201,350,247,191,160', 'Jim', '2015-06-24 03:58:24'),
(8, '06-013-046', 2012, 45600, 1, 'K', 'poly', '230,273,313,317,290,363,207,319', 'Bob', '2015-06-24 03:59:14'),
(9, '06-013-094', 2012, 70000, 12, 'H', 'poly', '156,7,245,51,219,101,130,53', 'Trey', '2015-06-24 03:58:35'),
(10, 'GRR', 2012, 0, 0, 'I', 'poly', '214,116,374,201,378,190,397,198,397,1,270,1', 'State', '2015-06-24 03:58:51'),
(11, '06-013-0074', 2012, 70000, 12, 'J', 'poly', '203,169,265,204,228,271,157,232,163,211,190,198', 'Privy', '2015-06-24 21:10:37');
...
(1, 1, 'Property', '2014-12-31 20:15:43'),
(2, 2, 'Property', '2014-12-31 20:15:43'),
(3, 3, 'Property', '2014-12-31 20:16:24'),
(4, 7, 'Owner', '2014-12-31 20:16:24'),
(5, 4, 'Property', '2014-12-31 20:16:56'),
(6, 6, 'Property', '2014-12-31 20:16:56');

-- --------------------------------------------------------

--
-- Table structure for table `tblParcelBill`
--

CREATE TABLE IF NOT EXISTS `tblParcelBill` (
  `fnkParcelId` int(11) NOT NULL,
  `fnkBillId` int(11) NOT NULL,
  `fnkContractId` int(11) NOT NULL,
  `fnkPersonId` int(11) NOT NULL,
  `pmkDatePaid` date NOT NULL,
  `fldDateRecieved` date NOT NULL,
  `fldAmountPaid` double NOT NULL,
  `fldCheckNumber` varchar(50) NOT NULL,
  `fldNotes` tinytext NOT NULL,
  `fldLastUpdated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 1, '0.000', 0, '2015-06-24 18:01:49'),
(1, 4, '0.000', 0, '2015-06-24 22:01:49'),
(2, 1, '0.143', 0, '2015-06-24 18:01:49'),
(2, 4, '0.250', 0, '2015-06-24 22:01:49'),
(3, 1, '0.143', 0, '2015-06-24 18:01:49'),
(3, 4, '0.250', 0, '2015-06-24 22:01:49'),
(4, 1, '0.143', 0, '2015-06-24 18:01:49'),
(4, 4, '0.250', 0, '2015-06-24 22:01:49'),
(5, 1, '0.143', 0, '2015-06-24 18:01:49'),
(5, 4, '0.000', 0, '2015-06-24 22:01:49'),
(6, 1, '0.143', 0, '2015-06-24 18:01:49'),
(6, 4, '0.250', 0, '2015-06-24 22:01:49'),
(7, 1, '0.143', 0, '2015-06-24 18:01:49'),
(7, 4, '0.000', 0, '2015-06-24 22:01:49'),
(8, 1, '0.143', 0, '2015-06-24 18:01:49'),
(8, 4, '0.000', 100, '2015-06-24 22:01:49'),
(9, 1, '0.143', 0, '2015-06-24 18:01:49'),
(9, 4, '0.000', 100, '2015-06-24 22:01:49');
...
(1, 'Robert', 'Erickson', 'rerickso@uvm.edu', '', 20, '2014-12-31 05:19:57'),
(2, 'Kevin', 'Mitchell', '', '', 0, '2014-12-31 05:19:57'),
(3, 'Bernice', 'McCuen-Mitchell', '', '', 0, '2014-12-31 05:20:57'),
(4, 'Thomas', 'Hirchak III', '', '', 0, '2014-12-31 05:20:57'),
(5, 'Norman W', 'Prive', '', '', 0, '2014-12-31 05:22:13'),
(7, 'Reginald F', 'Godin', '', '', 0, '2014-12-31 05:25:47'),
(8, 'Rev', 'Trust', '', '', 0, '2014-12-31 05:25:47'),
(9, 'Doris', 'Palumbo', '', '', 0, '2014-12-31 05:27:10'),
(10, 'Fredrick L', 'Woeckener', '', '', 0, '2014-12-31 05:27:10'),
(11, 'James', 'Merikangas', '', '', 0, '2014-12-31 19:37:18'),
(12, 'Joseph (Trey)', 'Crisco', '', '', 0, '2014-12-31 19:37:18');
...
(1, 11, 'Home', '2014-12-31 22:11:22'),
(11, 9, 'Home', '2014-12-31 22:11:22'),
(12, 10, 'Home', '2014-12-31 22:11:45');
...
--
-- Dumping data for table `tblPersonProposal`
--

INSERT INTO `tblPersonProposal` (`fnkPersonId`, `fnkProposalId`, `fldOrder`, `fldLastUpdated`) VALUES
(1, 1, 22, '2017-03-23 14:29:04');
...
INSERT INTO `tblProposal` (`pmkProposalId`, `fldTitle`, `fldDescription`, `fldDollarAmount`, `fldFinalAmount`, `fldDateSubmitted`, `fldDateUpdated`, `fldType`, `fldVotingClosed`, `fldApproved`) VALUES
(1, 'Test Proposal', 'This is a test of making a proposal!', 25, 15, '2017-03-23 00:00:00', '2017-03-23 12:58:24', 'Road Work', '2017-03-30 00:00:00', 0),
(2, 'Test Proposal', 'This is a test of making a proposal!', 25, 15, '2017-03-23 00:00:00', '2017-03-23 12:58:30', 'Road Work', '2017-03-30 00:00:00', 0);
...
--
-- Dumping data for table `tblProposalComment`
--

INSERT INTO `tblProposalComment` (`pmkCommentId`, `fldComment`, `fnkPersonId`, `fnkProposalId`, `fldLastUpdated`) VALUES
(1, 'Hello World!', 1, 1, '2017-03-23 14:59:40');
...
--
ALTER TABLE `tblBill`
  ADD PRIMARY KEY (`pmkBillId`),
  ADD KEY `fnkContractId` (`fnkContractId`);
...
ALTER TABLE `tblParcelAddress`
  ADD PRIMARY KEY (`fnkParcelId`,`fnkAddressId`),
  ADD KEY `fnkAddressId` (`fnkAddressId`);

--
-- Indexes for table `tblParcelBill`
--
ALTER TABLE `tblParcelBill`
  ADD PRIMARY KEY (`pmkDatePaid`),
  ADD KEY `fnkParcelId` (`fnkParcelId`,`fnkBillId`,`fnkContractId`,`fnkPersonId`,`pmkDatePaid`),
  ADD KEY `fnkBillId` (`fnkBillId`),
  ADD KEY `fnkPersonId` (`fnkPersonId`),
  ADD KEY `fnkContractId` (`fnkContractId`);
...
ALTER TABLE `tblParcelContracts`
  ADD PRIMARY KEY (`fnkParcelId`,`fnkContractId`),
  ADD KEY `fnkContractId` (`fnkContractId`);
...
ALTER TABLE `tblParcelOwner`
  ADD PRIMARY KEY (`fnkParcelId`,`fnkOwnerId`,`fldOrder`),
  ADD KEY `fnkOwnerId` (`fnkOwnerId`);
...
ALTER TABLE `tblPersonAddress`
  ADD PRIMARY KEY (`fnkPersonId`,`fnkAddressId`),
  ADD KEY `fnkAddressId` (`fnkAddressId`);
...
ALTER TABLE `tblPersonContact`
  ADD PRIMARY KEY (`fnkPersonId`,`fnkContactId`,`fldOrder`),
  ADD KEY `fnkContactId` (`fnkContactId`);

--
-- Indexes for table `tblPersonProposal`
--
ALTER TABLE `tblPersonProposal`
  ADD PRIMARY KEY (`fnkPersonId`,`fnkProposalId`,`fldOrder`),
  ADD KEY `fnkProposalId` (`fnkProposalId`);
...
ALTER TABLE `tblProposal`
  ...
  ADD KEY `pmkProposalId` (`pmkProposalId`);
...
ALTER TABLE `tblProposalDocuments`
  ...
  ADD KEY `pmkDocumentId` (`pmkDocumentId`),
  ADD KEY `fnkProposalId` (`fnkProposalId`);
...
ALTER TABLE `tblProposalVote`
  ADD PRIMARY KEY (`fnkPersonId`,`fnkProposalId`),
  ADD KEY `fnkProposalId` (`fnkProposalId`);
...
--
ALTER TABLE `tblBill`
  MODIFY `pmkBillId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `tblProposal`
  MODIFY `pmkProposalId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tblProposalComment`
--
ALTER TABLE `tblProposalComment`
  MODIFY `pmkCommentId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
-- Constraints for table `tblParcelBill`
--
ALTER TABLE `tblParcelBill`
  ADD CONSTRAINT `tblParcelBill_ibfk_1` FOREIGN KEY (`fnkBillId`) REFERENCES `tblBill` (`pmkBillId`),
  ADD CONSTRAINT `tblParcelBill_ibfk_2` FOREIGN KEY (`fnkParcelId`) REFERENCES `tblParcel` (`pmkParcelId`),
  ADD CONSTRAINT `tblParcelBill_ibfk_3` FOREIGN KEY (`fnkPersonId`) REFERENCES `tblPerson` (`pmkPersonId`),
  ADD CONSTRAINT `tblParcelBill_ibfk_4` FOREIGN KEY (`fnkContractId`) REFERENCES `tblContracts` (`pmkContractId`);
...
--
ALTER TABLE `tblProposalComment`
  ADD CONSTRAINT `tblProposalComment_ibfk_1` FOREIGN KEY (`fnkPersonId`) REFERENCES `tblPerson` (`pmkPersonId`),
  ADD CONSTRAINT `tblProposalComment_ibfk_2` FOREIGN KEY (`fnkProposalId`) REFERENCES `tblProposal` (`pmkProposalId`);

--
-- Constraints for table `tblProposalDocuments`
--
ALTER TABLE `tblProposalDocuments`
  ADD CONSTRAINT `tblProposalDocuments_ibfk_1` FOREIGN KEY (`fnkProposalId`) REFERENCES `tblProposal` (`pmkProposalId`);
